...
public class HundirlaFlotacasa {
    ...
    public static void main(String[] args) {
       ...
       mostraragua(agua);
        ...
        boolean buquehundido=false;
        boolean barcohundido=false;
        boolean barquitohundido=false;
        do {  
        ...
        if(barc==0)
         ...
         if(barquito==0)
           {
               System.out.println("y hundido");
               barquitohundido=true;
               barquito++;
           }
          mostraragua(juego);
      
        } while (buquehundido==false||barcohundido==false||barquitohundido==false);       
        System.out.println("Enhorabuena!!!!! Has derribado todos los barcos");
    }
